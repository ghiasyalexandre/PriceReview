        ...
        if(logstatus === 0){
                ...
                var row = ` <div class="card card-body"> 
                    <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row"> 
                        ...
                        <div class="media-body"> 
                            <h6 class="media-title font-weight-semibold"> <a href="productPage.html?${jsonArray[i].product_id};${jsonArray[i].product_price};${jsonArray[i].product_rating};${jsonArray[i].product_image};${jsonArray[i].number_reviews};${jsonArray[i].number_rating}" data-abc="true">${jsonArray[i].product_name} | $ ${jsonArray[i].product_price}</a> </h6>                           
                            <p class="mb-3">${jsonArray[i].product_descrip} </p> 
                            <ul class="list-inline list-inline-dotted mb-0"> 
                                <li class="list-inline-item">
                                    <a href="productPage.html?${jsonArray[i].product_id};${jsonArray[i].product_price};${jsonArray[i].product_rating};${jsonArray[i].product_image};${jsonArray[i].number_reviews};${jsonArray[i].number_rating}" data-abc="true">View Reviews</a>
                                </li>                                 
                            </ul>                             
                        </div>     
                        <li class="list-inline-item">                                                                              
            ...
            var row = ` <div class="card card-body"> 
                    <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row"> 
                        ...
                        <div class="media-body"> 
                            <h6 class="media-title font-weight-semibold"> <a href="productPage.html" data-abc="true">${jsonArray[i].product_name} | $ ${jsonArray[i].product_price}</a> </h6>                           
                            <p class="mb-3">${jsonArray[i].product_descrip} </p> 
                            <ul class="list-inline list-inline-dotted mb-0"> 
                                <li class="list-inline-item">
