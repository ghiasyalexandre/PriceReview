...
function listreviewsbyproduct(){
    ...
    var productrate = a[2];
    var productimage = a[3];
    var productnumberreviews = a[4];
    var productnumberrates = a[5];

    document.getElementById('productimage').src = productimage;
    document.getElementById("rating").innerHTML = productrate + ' average based on ' + productnumberreviews + ' reviews and ' + productnumberrates + ' rates.';
